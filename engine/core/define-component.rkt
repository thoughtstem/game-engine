     ...
     (with-syntax 
       ...
       (quasisyntax/loc stx
         (begin
           ...
           (define #;/contract 
             (update-entity-COMPONENT-FIELD e f)
             #;
             (-> entity? any/c entity?)
             (update-component e COMPONENT? 
                               (update-COMPONENT-FIELD f)))
